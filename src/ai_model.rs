...
impl AIModel {
    ...
    fn init_vocab(&mut self) {
        // Расширенный русский и английский словарь
        let base_words = vec![
            // Приветствия и вежливость
            "привет", "здравствуй", "здравствуйте", "добрый", "день", "утро", "вечер",
            "пока", "до", "свидания", "спасибо", "пожалуйста", "извините", "простите",
            ...
            "этот", "эта", "это", "тот", "та", "те", "весь", "все", "всё", "какой", "который",
            "i", "you", "he", "she", "it", "we", "they", "my", "your", "his", "her", "our", "their",
            "this", "that", "these", "those", "what", "which", "who", "where", "when", "why", "how",
            
            // Вопросительные слова
            "кто", "что", "где", "куда", "откуда", "когда", "почему", "зачем", "как", "сколько",
            "который", "какой", "чей", "чья", "чьё", "чьи",
            
            // Глаголы
            "быть", "есть", "был", "была", "было", "были", "буду", "будешь", "будет", "будем", "будете", "будут",
            "делать", "сделать", "иметь", "знать", "мочь", "хотеть", "идти", "прийти", "говорить", "сказать",
            "видеть", "понимать", "думать", "работать", "любить", "жить", "дать", "взять", "смотреть",
            "be", "is", "am", "are", "was", "were", "been", "being", "have", "has", "had", "do", "does", "did",
            "make", "get", "know", "think", "see", "come", "want", "use", "find", "give", "tell", "work",
            "call", "try", "ask", "need", "feel", "become", "leave", "put", "mean", "keep", "let", "begin",
            
            // Предлоги и союзы
            "в", "во", "на", "с", "со", "к", "ко", "у", "о", "об", "от", "до", "для", "за", "по", "из", "без",
            "под", "над", "перед", "между", "через", "при", "про", "и", "а", "но", "или", "да", "ни", "не",
            "если", "чтобы", "что", "когда", "как", "потому", "поэтому", "так", "тоже", "также",
            ...
            "and", "or", "but", "if", "so", "than", "because", "while", "where", "though", "since", "until",
            
            // Числительные
            "один", "одна", "одно", "два", "две", "три", "четыре", "пять", "шесть", "семь", "восемь", "девять", "десять",
            "первый", "второй", "третий", "много", "мало", "несколько",
            "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten",
            "first", "second", "third", "many", "much", "some", "few", "several", "all", "each", "every",
            
            // Прилагательные
            "хороший", "плохой", "большой", "маленький", "новый", "старый", "молодой", "важный", "нужный",
            "правильный", "неправильный", "красивый", "простой", "сложный", "лёгкий", "тяжёлый",
            "good", "bad", "great", "small", "big", "large", "new", "old", "young", "high", "low", "long", "short",
            "important", "different", "right", "wrong", "easy", "hard", "beautiful", "simple", "complex",
            
            // Существительные (общие)
            "человек", "люди", "время", "год", "день", "жизнь", "работа", "дело", "место", "мир", "страна",
            "город", "дом", "комната", "рука", "нога", "голова", "глаз", "лицо", "вода", "еда", "хлеб",
            "деньги", "вопрос", "ответ", "слово", "язык", "книга", "история", "система", "проблема",
            "people", "person", "time", "year", "day", "life", "work", "world", "country", "state", "city",
            "home", "house", "room", "hand", "eye", "face", "water", "food", "money", "question", "answer",
            "word", "language", "book", "story", "system", "problem", "way", "thing", "part", "place",
            
            // IT и программирование
            "программа", "код", "файл", "данные", "система", "компьютер", "интернет", "сайт", "приложение",
            "функция", "переменная", "класс", "объект", "метод", "алгоритм", "язык", "программирование",
            "python", "rust", "javascript", "java", "code", "program", "file", "data", "computer", "internet",
            "website", "application", "app", "function", "variable", "class", "object", "method", "algorithm",
            
            // AI и машинное обучение
            "модель", "обучение", "нейронный", "сеть", "данные", "алгоритм", "искусственный", "интеллект",
            "машинный", "глубокий", "learning", "model", "training", "neural", "network", "deep", "artificial",
            "intelligence", "machine", "ai", "ml", "algorithm", "dataset", "fp64", "fp32", "precision",
            
            // Служебные токены
            "<PAD>", "<START>", "<END>", "<UNK>", "<MASK>",
        ];
